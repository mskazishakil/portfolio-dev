...
//         style={{
//           backgroundImage:
//             "linear-gradient(rgba(200,230,68,0.04) 1px,transparent 1px),linear-gradient(90deg,rgba(200,230,68,0.04) 1px,transparent 1px)",
...
//         style={{ background: "radial-gradient(circle,rgba(200,230,68,0.13) 0%,transparent 70%)" }}
//       />
//       <div
//         className="absolute -bottom-24 -left-16 w-[300px] h-[300px] rounded-full pointer-events-none"
...
//                 width: 310,
//                 height: 310,
//                 border: "1px dashed rgba(200,230,68,0.2)",
...
//                 width: 338,
//                 height: 338,
//                 border: "1px solid rgba(200,230,68,0.07)",
...
//               style={{ top: -8, left: -8, width: 36, height: 36, borderTop: "1.5px solid rgba(200,230,68,0.6)", borderLeft: "1.5px solid rgba(200,230,68,0.6)" }}
//             />
//             <div
//               className="absolute z-20 pointer-events-none"
//               style={{ bottom: -8, right: -8, width: 36, height: 36, borderBottom: "1.5px solid rgba(200,230,68,0.35)", borderRight: "1.5px solid rgba(200,230,68,0.35)" }}
//             />
//             {/* Image card */}
//             <div
...
//                 border: "0.5px solid rgba(200,230,68,0.14)",
...
//                 style={{ background: "linear-gradient(135deg,rgba(200,230,68,0.07) 0%,transparent 55%,rgba(200,230,68,0.03) 100%)" }}
//               />
//               <img
//                 src={profile}
//                 alt="Md Shakil Islam"
...
//               {/* Available badge */}
//               <div
//                 className="absolute bottom-3 left-1/2 -translate-x-1/2 flex items-center gap-2 rounded-lg px-3 py-1.5"
//                 style={{
//                   background: "rgba(8,12,16,0.88)",
//                   border: "0.5px solid rgba(200,230,68,0.22)",
...
//                 />
//                 <span className="text-[11px] tracking-wide text-[#8a9ba8]">Available for hire</span>
//               </div>
//             </div>
//           </div>

//           {/* Stat cards */}
//           <div className="flex flex-row lg:flex-row gap-3 mt-5 justify-center">
//             {[
//               { n: "1+", l: "Years Exp." },
//               { n: "10+", l: "Projects" },
//               { n: "5+", l: "Skills" },
...
//               <div
//                 key={stat.l}
//                 className="rounded-xl px-4 py-3 text-center cursor-default transition-all duration-200 hover:border-[rgba(200,230,68,0.5)]"
//                 style={{
...
//                 }}
//               >
//                 <p className="font-bold leading-none text-[#c8e644]" style={{ fontSize: "clamp(18px,4vw,22px)", fontFamily: "serif" }}>
//                   {stat.n}
//                 </p>
//                 <p className="text-[10px] tracking-widest uppercase mt-1 text-[#3d5060]">{stat.l}</p>
//               </div>
//             ))}
//           </div>
//         </div>
...
//             <span className="text-[11px] font-medium tracking-[0.22em] uppercase text-[#c8e644]">Available for work</span>
//           </div>

//           {/* Greeting */}
//           <p ref={greetRef} className="text-sm font-light tracking-widest text-[#5a7080] mb-1">
//             Hello, I'm
//           </p>
...
//           <h1
//             ref={nameRef}
//             className="font-black leading-none mb-2 text-[#f0f4f0]"
//             style={{
...
//           <div
//             ref={roleRef}
//             className="font-bold italic mb-6 text-[#8a9ba8]"
//             style={{
...
//           >
//             A passionate{" "}
//             <span className="text-[#c8e644]">{displayedRole}</span>
//             <span
//               className="inline-block w-[3px] ml-1 align-middle bg-[#c8e644]"
...
//             style={{ width: 52, height: 1, background: "linear-gradient(to right,rgba(200,230,68,0.6),transparent)" }}
//           />

//           {/* Bio */}
//           <p
//             ref={bioRef}
//             className="text-sm font-light leading-[1.9] text-[#6a7f8c] mb-8 mx-auto lg:mx-0"
//             style={{ maxWidth: 440 }}
//           >
//             Focused on creating{" "}
//             <span className="text-[#9ab0bc] font-normal">clean, responsive</span> and
//             user-friendly web interfaces. Turning ideas into modern designs using{" "}
//             <span className="text-[#9ab0bc] font-normal">HTML, CSS, JavaScript</span> and{" "}
//             <span className="text-[#9ab0bc] font-normal">React</span>.
//           </p>

//           {/* CTA Buttons */}
//           <div ref={ctaRef} className="flex flex-wrap gap-3 justify-center lg:justify-start mb-5">
//             <Link to="error" className="group">
//             <button className="text-[11px] font-semibold tracking-[0.12em] uppercase rounded-sm bg-[#c8e644] text-[#080c10] px-7 py-3 transition-all duration-200 hover:bg-[#d8f060] hover:-translate-y-0.5 active:scale-95">
//               View My Work
//             </button>
//             </Link>
//             <a
//              href="/src/CV/Untitled document (5).pdf"
//              download
//             className="text-[11px] tracking-[0.12em] uppercase rounded-sm px-7 py-3 transition-all duration-200 text-[#6a7f8c] border border-[rgba(106,127,140,0.35)] bg-transparent hover:border-[#c8e644] hover:text-[#c8e644] active:scale-95 flex items-center gap-2">
//                <span className="text-lg group-hover:animate-bounce hover:text-[#c8e644]">⬇️</span>
//               Download CV
//             </a>
//           </div>

//           {/* Skill tags */}
//           <div ref={tagsRef} className="flex flex-wrap gap-2 justify-center lg:justify-start">
//             {skills.map((skill) => (
//               <span
//                 key={skill}
//                 className="text-[10px] font-medium tracking-[0.1em] uppercase px-3 py-1 rounded-full cursor-default transition-all duration-200 text-[#3d5060] border border-[rgba(61,80,96,0.5)] hover:text-[#c8e644] hover:border-[rgba(200,230,68,0.4)]"
//               >
//                 {skill}
//               </span>
//             ))}
...
//         <span className="text-[9px] tracking-[0.2em] uppercase text-[#2d4050]">Scroll</span>
//         <div
//           className="w-px"
//           style={{ height: 36, background: "linear-gradient(to bottom,transparent,rgba(200,230,68,0.5))" }}
//         />
//       </div>
